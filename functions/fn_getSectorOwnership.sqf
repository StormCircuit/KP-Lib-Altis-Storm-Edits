/*
    ...
    Description:
        ...
        Note by Storm:
        It does this check not by actually checking the marker but by calculating the ratio of enemy units to friendly units.
        A side needs to posses 85% control to own a sector.
