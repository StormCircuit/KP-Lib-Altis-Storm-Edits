...
//Storms code
//intialize VAM for vehicles
//initialize kp_wreckspawn to spawn wrecks all over the map (DISABLED BC AI CANT PATH AROUND)
[] execVM "VAM_GUI\VAM_GUI_init.sqf";

//[] execVM "StormsScripts\kp_wreckspawn.sqf";
