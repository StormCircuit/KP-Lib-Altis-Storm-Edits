...
GRLIB_secondary_objective_impact = 80;                                  // Whole number percentage POINT (so if this equals 7 then readiness goes down by 7 points) impact against enemy combat readiness for a successful FOB hunt.
...
GRLIB_cleanup_delay = 2400;                                             // Time in seconds until bodies of dead soldiers are cleaned up.

KP_liberation_fill_mags = true;											// Fill magazines on loading loadout?

GRLIB_blufor_cap = 150;                                                 // Cap for BLUFOR.
...
KP_liberation_cr_vehicle_penalty = 10;                                   // Civil Reputation penalty for stealing a civilian vehicle.
...
KP_liberation_cr_wounded_chance = 100;                                  // Chance (0-100) that there are wounded civilians right after capturing a sector.
...
KP_liberation_civinfo_task_duration = 2400;                             // Duration until the task will despawn if no player is near. (seconds)

KP_liberation_convoy_ambush_chance = 100;                               // Chance that a logistic convoy will be ambushed, when civil reputation is low.
KP_liberation_convoy_ambush_duration = 2400;                            // Duration of the convoy ambush event. (seconds)
...
KP_liberation_resistance_at_chance = 50;                                // Chance that a guerilla unit has a RPG. (tier 2 and 3)
